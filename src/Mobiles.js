...
import {phonesData} from "./Mobiles.data"
...
const Mobiles = () => {
  ...
  return (
    <div>
        <h1 style={{backgroundColor:'blue', color:'white'}}><center>Mobiles</center></h1>
        ...
        <div className='d-inline-flex p-3 m-4 ' key={item.id}>
                ...
                <img className='p-2'style={{height: '15rem'}} src= {require(`./phone_images/${item.image}.png`)} class="card-img-top" alt="images"></img>
